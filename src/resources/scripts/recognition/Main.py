...
#Dirs
parser.add_argument('--dataset_main_path', dest='dataset_main_path', type=str, default='/datawork/DATA/Prove/', help='Main path of the dataset images')
parser.add_argument('--checkpoints_main_path', dest='checkpoints_main_path', type=str, default='/datawork/EXPERIMENTS/LOIC/', help='Path where checkpoints have been saved' )
parser.add_argument('--results_main_path', dest = 'results_main_path', default = '/datawork/EXPERIMENTS/LOIC/', help = 'Path where the results files will be saved')
