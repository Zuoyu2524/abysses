<h4>Abysses notifications</h4>
<p class="text-muted">
    Notifications when the state of one of your Abysses jobs changes.
</p>
...
<script type="text/javascript">
    biigle.$mount('abysses-notification-settings', {
        mixins: [biigle.$require('core.mixins.notificationSettings')],
        data: {
            settings: '{!! $user->getSettings('abysses_notifications', config('user_storage.notifications.default_settings')) !!}',
            settingsKey: 'abysses_notifications',
        },
    });
</script>
@endpush
